...
const cases: Array<{ name: string; schema: OutputSchema; raw: unknown }> = [
      ...
      accounts: [
        {
          ...
          interestRate: null,
          currency: "USD",
          balanceInDefaultCurrency: 100.5,
          currentBalanceInDefaultCurrency: 100.5,
          exchangeRate: 1,
          isClosed: false,
        ...
        },
        {
          ...
          creditLimit: null,
          interestRate: 6,
          // A foreign account with no rate into the default currency: the
          // converted figures are null and the pair is named below.
          currency: "CAD",
  ...
  {
    name: "calculateOutput (convert branch)",
    schema: schemas.calculateOutput,
    raw: {
      result: 1098.75,
