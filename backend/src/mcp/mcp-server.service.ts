    ...
    const server = new McpServer(
      { name: "monize", version: backendPkg.version },
      {
        instructions: [
          ...
          "- list_transactions and list_accounts accept names (account/category/payee) and resolve them internally. For other tools that take UUIDs, use list_accounts or list_categories first to resolve names to IDs.",
