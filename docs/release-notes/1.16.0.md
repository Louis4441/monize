...
- The **Transactions** account info widget gains a caret that opens the account switcher, so you can change account without going back to the list. Its menu is drawn above everything and clamped to the viewport, and on a touch device it opens without the keyboard leaping up.
