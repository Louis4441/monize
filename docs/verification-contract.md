...
| INV-INTRADAY-001 an intraday bar holds what its own day held | **required** | -- | supporting | -- | -- | -- | -- | optional |
...
| INV-PORTMOVE-008 late close restates the baseline | **required** | supporting | optional | -- | -- | -- | -- | optional |
