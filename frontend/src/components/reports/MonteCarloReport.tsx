            ...
            {form.cashFlows.length === 0 ? (
              ...
              <div className="space-y-2 mb-3">
                {form.cashFlows.map((cf, idx) => (
                  <div
                    key={idx}
                    className="border border-gray-200 dark:border-gray-700 rounded-md p-3 grid grid-cols-1 md:grid-cols-12 gap-2 items-center"
                  >
                    ...
                    <div
                      className={`flex items-center gap-2 ${cf.flowType === 'RECURRING' ? 'md:col-span-3' : 'md:col-span-4'}`}
                    >
